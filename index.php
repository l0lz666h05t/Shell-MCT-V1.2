<?php
//{"lang":"en","auth_pass":"d41d8cd98f00b204e9800998ecf8427e","error_reporting":"2"}
/*--------------------------------------------------
 | PHP FILE MANAGER
 +--------------------------------------------------
 | phpFileManager 1.5
...
function dir_list_form() {
    ...
    if ($opdir = @opendir(fs_encode($fm_current_dir))) {
        ...
        function about_form(){
            openModalWindow('".addslashes($fm_path_info["basename"])."?action=13','".et('About')."',800,600);
        }
...
function about_form(){
    ...
    <iframe id=\"aboutIframe\" name=\"aboutIframe\" src=\"http://www.dulldusk.com/phpfm\" scrolling=\"yes\" frameborder=\"0\"></iframe>
    </body>\n</html>";
}
// +--------------------------------------------------
